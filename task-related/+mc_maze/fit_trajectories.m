...
[Z, Phi_labels] = mc_maze.preprocess_behavior(Z, Settings);
...
% Reformat smoothed spikes and behavioral variables into cell arrays (conditions) of cell arrays (trials).
