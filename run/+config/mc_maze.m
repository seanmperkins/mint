...
function [Settings, HyperParams] = mc_maze()
...
if HyperParams.causal
    HyperParams.window_length = 300;
else
    HyperParams.window_length = 580;
end
